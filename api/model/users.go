...
var (
	userAllColumns            = []string{"id", "username", "email", "password", "created_at", "updated_at", "deleted_at"}
	userColumnsWithoutDefault = []string{"username", "email", "password", "updated_at", "deleted_at"}
